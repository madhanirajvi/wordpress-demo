<?php
/**
 * Heera Customizer functionality
 * Theme Name: Heera
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in Heera.
	 *
	 * @since Heera 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in Heera.
	 *
	 * @since Heera 1.0
	 *
	 * @param array $args {
...
/**
 * Registers color schemes for Heera.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Heera.
	 *
...
/**
 * Retrieves the current Heera color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for Heera.
 *
...
/**
 * Handles sanitization for Heera color schemes.
 *
